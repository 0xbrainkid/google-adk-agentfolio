/**
 * google-adk-agentfolio — AgentFolio integration for Google ADK
 *
 * Give Google Agent Development Kit agents access to AgentFolio agent identity, trust scores, and marketplace.
 *
 * Provides:
...
/**
 * Create a configured AgentFolio toolkit for Google ADK.
